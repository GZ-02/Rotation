...
enum DisplayModeType { TEXTURED_QUAD = 1, ICICLE = 2, ICICLE2 = 3, ICICLE3 = 4, ICICLE4 = 5, SURFACE = 6 };
...
void drawIcicle() {
	...
	glBegin(GL_POLYGON);
	glTexCoord2f(textureX, textureY + 5);
	glVertex3f(0, -0.8, 0);
	glTexCoord2f(textureX + 5, textureY);
	glVertex3f(0.15, 0, 0);
	glTexCoord2f(textureX, textureY);
	glVertex3f(0, 0.8, 0);
	glTexCoord2f(textureX + 5, textureY);
